                ...
                <div className="row">
                    ...
                    <div  className="col-12 col-md-6 col-lg-3">
                        <div>
                            ...
                            <p>Total Invoice : 1</p>
                            <p>Due Invoice : 0</p>
                            <Link to={"/dashboard/supplier/purchase-porduct-list/2"} className="btn btn-pill btn-primary btn-air-primary"> <i className="fa fa-bars me-2"></i>Products</Link>
                        </div>
                    </div>
                    <div  className="col-12 col-md-6 col-lg-3">
                        <div>
                            ...
                            <button onClick={addToggle} type="button" className="btn btn-pill btn-primary btn-air-primary"> <i className="fa fa-bars me-2"></i>Add Balance</button>
                            <button type="button" className="btn btn-pill btn-primary btn-air-primary mt-2"> <i className="fa fa-minus me-1"></i>Subtract Balance</button>
                        </div>
                    </div>
                </div>
            </div>
