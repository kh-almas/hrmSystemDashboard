...
const EditVariantImage = ({handelUploadData, photos, setPhotos, singleRowData, rowImage, setRowImage, selectedPhotos, setSelectedPhotos, handleDeletedPhotos}) => {
    ...
    const handleAddPhoto = (e, singleRowData) => {
        ...
        const makePhotoArray = [...rowImage[singleRowData], ...newPhotos]
        setPhotos(makePhotoArray);
        rowImage[singleRowData] = makePhotoArray;
    };
