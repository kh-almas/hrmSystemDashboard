...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                if(data?.productType) {
                    setTypeChange({value: data?.productType, label: data?.productType});
                    setType(data?.productType);
                }

                if(data?.measurementUnit) {
                    setMeasurementUnit({value: data?.measurementUnit, label: data?.measurementUnit})
                }

                if(data?.weightUnit) {
                    setWeightUnit({value: data?.weightUnit, label: data?.weightUnit})
                }
    ...
    }, [setValue, singleProductData?.productHeight]);
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className='row row-cols-1 row-cols-md-2'>
                                                            {type == "Single" || type == "Combo" || type === "Variant" ? (
                                                                <div>
                                                                    {console.log(singleProductData?.productHeight,'singleProductData?.productHeight')}
                                                                    {/*<Input*/}
                                                                    {/*    labelName={"Height"}*/}
                                                                    {/*    inputName={"height"}*/}
                                                                    {/*    inputType={"number"}*/}
                                                                    {/*    placeholder={"height"}*/}
                                                                    {/*    defaultValue={singleProductData?.productHeight}*/}
