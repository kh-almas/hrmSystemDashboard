...
const OpeningStock = () => {
  ...
  const [
    allOpeningStockStatus,
    allOpeningStockReFetch,
    allOpeningStockData,
    allOpeningStockError,
  ] = GetAllOpeningStock();
    ...
    <>
      ...
      <Card className="mt-2">
        <Collapse isOpen={showFromForAdd}>
          <AddOpeningStock
            allOpeningStockReFetch={allOpeningStockReFetch}
          ...
          <div className="col-sm-12">
            <div className="card" style={{ padding: "20px" }}>
              <DataTable
                ...
                editLink={
                  "/dashboard/inventory-management/inventory/opening-stock/update/"
                }
                getAllData={allOpeningStock}
