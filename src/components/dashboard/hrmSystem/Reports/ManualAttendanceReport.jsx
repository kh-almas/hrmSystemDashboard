        ...
        <Page size="A4" style={{margin: '10px', padding: '0 20px 0 0', marginRight: '20px'}}>
            <View style={{margin: '10px', padding: '10px',}}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: "center", marginTop: "15px"}}>
                    <View>
                        <Text style={{fontSize: '16px', margin: 'auto'}}>Manual Attendance Reports</Text>
        ...
        <>
            <div className="pt-4 mb-3">
                ...
                <div className="d-flex justify-content-center">
                    <PDFDownloadLink document={<ManualAttendanceReportPDF />} fileName="ManualAttendanceReport.pdf" className={"btn btn-primary"}>
