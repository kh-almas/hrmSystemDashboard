                ...
                <ModalBody>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="row row-cols-1 row-cols-lg-2">
                            <div>
                                <Select labelName={"Warning By"} name={"warningby"} placeholder={"Select a option"} options={['Accountant',]}/>
                            </div>
                            <div>
                                <Select labelName={"Warning To"} name={"warningto"} placeholder={"Select a option"} options={['Accountant',]}/>
                            </div>
                        </div>

                        <div className="row row-cols-1 row-cols-lg-2">
                            <div>
                                <Input labelName={'Subject'} inputName={'subject'} inputType={'text'} placeholder={'Enter subject'} validation={{...register("subject", { required: true })}}/>
                            </div>
                            <div>
                                <Input labelName={'Warning Date'} inputName={'date'} inputType={'date'}  validation={{...register("date", { required: true })}} />
                            </div>
                        </div>
                        <div>
