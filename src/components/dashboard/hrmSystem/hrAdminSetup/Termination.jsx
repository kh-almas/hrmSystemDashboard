            ...
            <Modal isOpen={modal} toggle={toggle}>
                ...
                <ModalBody>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="row row-cols-1 row-cols-lg-2">
                            <div>
                                <Input labelName={'Notice Date'} inputName={'noticedate'} inputType={'date'}  validation={{...register("noticedate", { required: true })}} />
                            </div>
                            <div>
                                <Input labelName={'Termination Date'} inputName={'terminationenddate'} inputType={'date'}  validation={{...register("terminationenddate", { required: true })}} />
                            </div>
                        </div>
