            ...
            <Modal isOpen={modal} toggle={toggle}>
                ...
                <ModalBody>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="row row-cols-1 row-cols-lg-2">
                            <div>
                                <Input labelName={'Date'} inputName={'date'} inputType={'date'}  validation={{...register("date", { required: true })}} />
                            </div>
                            <div>
                                <Input labelName={'Gift'} inputName={'gift'} inputType={'text'} placeholder={'Enter Gift'} validation={{...register("gift", { required: true })}}/>
                            </div>
                        </div>
