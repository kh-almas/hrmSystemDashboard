...
const Organaization = () => {
    ...
    useEffect(() => {
        setOrganaization(allCompany?.data?.body?.data);
    }, [allCompany])
    ...
    return (
        <>
            ...
            {
                oldData ?
                    <CompanyUpdateModal organization={organization} allCompanyReFetch={allCompanyReFetch} oldData={oldData} dataUpdateModal={dataUpdateModal} dataUpdateToggle={dataUpdateToggle}></CompanyUpdateModal>
                    : ''
            }
        </>
    );
