...
import { Border, Cancel, Color, Configuration, CopyText, Customize, Customizer, DarkLayout, Default, IconColor, Image, LTRLayout, LayoutType, LightLayout, MixLayout, ModalTitle, Pattern, PreviewRealTime, RTLLayout, SidebarBackgroundSetting, SidebarSettings, SidebarType } from '../../constant';
...
const ThemeCustomizer = () => {
    ...
    const config_layout_version = 'light';
    ...
    const handleCustomizerMix = (e) => {
        ...
        e.currentTarget.classList.add('active');
        localStorage.setItem('layout_version',e.currentTarget.getAttribute('data-attr'))
