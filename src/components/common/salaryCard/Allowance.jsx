    ...
    <div className="card" style={{ padding: "20px", height: "400px" }}>
      ...
      <div className="card-body">
        <div className="row m-t-15">
          <div className="col">
            <p className="text-center">No Allowance Found!</p>
          </div>
          {/* <div className="col">
            <p>Salary</p>
          </div> */}
      ...
      <Modal isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle}>Create Allowance</ModalHeader>
        <ModalBody>
            ...
            <div className="row">
              <div className="col">
                ...
                >
                  ...
                  <option>{"2Select Allowance"}</option>
                  <option>{"3Select Allowance"}</option>
                </select>
              </div>
              <div className="col">
