...
const AddSalaryGradeModal = ({modal, toggle, reFetch}) => {
    ...
    return (
        <>
            <BaseModal title={"Add Salary Grade"} dataModal={modal} dataToggle={toggle}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        <Input
                            ...
                            validation={{
                                ...register("salary_grade_name", { required: true }),
                            }}
                            error={errors?.salary_grade_name}
                        />
                    </div>
                    <div>
                        <Select
...
export default AddSalaryGradeModal;